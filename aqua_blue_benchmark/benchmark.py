...
class Result: 
    """
    A container object for the results of a timeseries prediction 
    """
    ...
    dep_var: np.typing.NDArray[np.floating]
    """ 
    The dependent variable predicted by the reservoir
    """
...
def compare_results(bench1: Result, bench2: Result):
    ...
    titles = ["\033[94m Model \033[0m", "\033[94m MSE \033[0m", "\033[94m RMSE \033[0m", "\033[94m NRMSE_MEAN \033[0m", "\033[94m NRMSE_MINMAX \033[0m", "\033[94m ELAPSED TIME (s) \033[0m"]
    ...
    if bench1.elapsed_time < bench2.elapsed_time: 
        data1.append(f"\033[92m{bench1.elapsed_time:.4f}\033[0m") 
        data2.append(f'{bench2.elapsed_time:.4f}')
    elif bench1.elapsed_time > bench2.elapsed_time:
        data2.append(f"\033[92m {bench2.elapsed_time:.4f} \033[0m")
        data1.append(f'{bench1.elapsed_time:.4f}')
    else: 
        data1.append(f'{bench1.elapsed_time:.4f}')
        data2.append(f'{bench2.elapsed_time:.4f}')
